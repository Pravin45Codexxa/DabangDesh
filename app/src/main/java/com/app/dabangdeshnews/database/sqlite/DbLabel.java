package com.app.dabangdeshnews.database.sqlite;

import static com.app.dabangdeshnews.Config.LABELS_SORTING;
...
import com.app.dabangdeshnews.model.Category;
...
public class DbLabel extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = BuildConfig.APPLICATION_ID + "_" + "label.db";
