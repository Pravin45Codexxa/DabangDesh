                        ...
                        switch (adsPref.getMainAds()) {
                            ...
                            case WORTISE:
                                if (!adsPref.getWortiseAppOpenAdUnitId().equals("0")) {
                                    if (!currentActivity.getIntent().hasExtra("unique_id")) {
                                        appOpenAdWortise.showAdIfAvailable(currentActivity, adsPref.getWortiseAppOpenAdUnitId());
                                    }
                                }
                                break;
                        }
        ...
        if (adsPref.getIsAppOpenAdOnStart()) {
            if (adsPref.getAdStatus()) {
                switch (adsPref.getMainAds()) {
                    ...
                    case WORTISE:
                        if (!adsPref.getWortiseAppOpenAdUnitId().equals("0")) {
                            appOpenAdWortise.showAdIfAvailable(activity, adsPref.getWortiseAppOpenAdUnitId(), onShowAdCompleteListener);
                            Constant.isAppOpen = true;
                        }
                        break;
                }
