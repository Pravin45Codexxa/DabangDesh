...
import com.app.dabangdeshnews.adapter.AdapterPost;
...
public class ActivityCategoryDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lytShimmerHead = findViewById(R.id.shimmer_view_head);
        ...
        adapterPost.setOnItemClickListener((view, obj, position) -> {
            Intent intent = new Intent(getApplicationContext(), com.app.dabangdeshnews.activity.ActivityPostDetail.class);
