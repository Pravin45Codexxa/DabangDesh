...
import static com.app.dabangdeshnews.util.Constant.POST_ORDER;
...
import com.app.dabangdeshnews.adapter.AdapterCategoryList;
import com.app.dabangdeshnews.adapter.AdapterRelated;
...
public class ActivityPostDetail extends AppCompatActivity {
    ...
    public void addToFavorite(CallbackPostDetail post) {
        ...
        btnFontSize.setOnClickListener(v -> {
            ...
            new MaterialAlertDialogBuilder(ActivityPostDetail.this)
